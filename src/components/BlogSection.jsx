...
const BlogSection = () => {
  return (
    ...
    <section className="max-w-7xl mx-auto px-6 py-16">
      ...
      <div className="w-full text-center mt-14"><a href="#" className="px-8 py-3 text-lg font-semibold rounded bg-indigo-600 text-white hover:bg-indigo-700 transition">Get More Career Advice</a></div>
    </section>
    </div>
  );
};
