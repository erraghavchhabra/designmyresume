...
const FooterCTA = () => {
  return (
    <section className="relative ms-ft-sec max-w-7xl mt-14 mx-auto overflow-hidden bg-gradient-to-r from-indigo-700 via-indigo-800 to-indigo-900 text-white py-16 px-6 sm:px-10 lg:px-20 rounded-3xl">
      {/* Background Vectors */}
      ...
      <div className="relative flex flex-col-reverse lg:flex-row items-center justify-between gap-12 lg:gap-20 max-w-7xl mx-auto">
        ...
        <div className="text-center lg:text-left max-w-lg">
          <h2 className="text-3xl sm:text-4xl font-bold leading-snug mb-6">
            ...
            <span className="text-indigo-300">Design My Resume Now’s Easy AI Resume Builder</span>
          </h2>
