...
export default function GenerateBullet() {
  return (
    <section
      className="relative  bg-cover bg-center bg-no-repeat flex flex-col justify-center"
            ...
            <div className="suggestion-box bg-[#e4eaff] p-4 rounded-lg min-h-[80px] mb-3" >
              <div className="flex items-center justify-between gap-2">
                <p className="text-gray-100">
                  <i>administer medications, collaborate on care plans, educate patients</i>
                </p>
                <a href="#" className="text-[#5bb6ff] whitespace-nowrap hover:underline">
                  Enhance This
                </a>
              </div>
